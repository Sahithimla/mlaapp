...
public class Schedule implements Serializable {
	...
	public String toString() {
		return "Schedule [id=" + id + ", subject=" + subject + ", topic=" + topic + ", description=" + description
				+ ", instructor=" + instructor + ", startDate=" + startDate + ", endDate=" + endDate + ", startTime="
				+ startTime + ", endTime=" + endTime + ", repeatSchedule=" + repeatSchedule + ", audioEnabled=" + audioEnabled
