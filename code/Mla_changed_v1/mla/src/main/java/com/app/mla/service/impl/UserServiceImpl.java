...
//			}
	...
	@Override
	@Transactional(propagation = Propagation.REQUIRED, readOnly = false, rollbackFor = Exception.class)
	public UserDTO getUserByUserName(String userName) throws ResourceNotFoundException, MLAServiceException {
		logger.debug("UserServiceImpl :: getUserById -> START");
		UserDTO userDTO = null;
	...
	private void validateUserDetails(UserDTO userDTO) throws BadRequestException {
		...
		userDTO.setUserType(userDTO.getUserType().toLowerCase());
